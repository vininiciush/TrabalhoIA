...
public final class ProductsFlyWeight {
	...
	static {
		...
		products.put(9, factory.create("Microondas Electrolux", 0.0424, 308.66, ""));
		products.put(10, factory.create("Geladeira Consul", 0.870, 1199.89, ""));
		products.put(11, factory.create("TV 50'", 0.290, 3999.90, ""));
